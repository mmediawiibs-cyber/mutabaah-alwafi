                            ...
                            {(evalDateArray || []).map((d) => {
                              ...
                              return (
                                <div
                                  ...
                                  className="flex-1 bg-slate-200/50 rounded-sm relative group h-full flex flex-col justify-end overflow-hidden"
                                >
                                  <div
                                    className={`${barColor} w-full rounded-sm transition-all shadow-sm`}
